...
def main() -> int:
    ...
    require(sys.argv == [SOURCE_REL.as_posix(), "--expected-head", args.expected_head], "preflight command drift")
    ...
    normalized = c02.normalized_run_argv(entry, 1, args.expected_head)
    c02.validate_activation(root, graph, identity, 1, args.expected_head, normalized)
