...
aftereffects, hierarchy, persistence, and split.
...
- a vocabulary for producer scaffolding, naturalization debt, and claim
  boundaries;
- the `RC-Ant` specification as the first detailed worked example;
- a foundation for future LGRC-oriented implementations.
...
identity, consciousness, or complete LGRC naturalization has already been
implemented.
...
agent-state language should be translated before implementation claims are made.
